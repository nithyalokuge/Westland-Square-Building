document.addEventListener("DOMContentLoaded", function () {
    ...
    function createMessageElement(text, sender = "You", isPinned = false) {
        ...
        pinButton.addEventListener("click", function () {
            if (!pinButton.classList.contains("pinned")) {
                ...
                pinButton.innerHTML = '<i class="fas fa-thumbtack"></i>'; // Solid icon when pinned
                pinMessage(text);
            } else {
                pinButton.classList.remove("pinned");
                pinButton.innerHTML = '<i class="far fa-thumbtack"></i>'; // Outline icon when unpinned
                unpinMessage(text);
            }
            saveMessages();
        });
    ...
    function pinMessage(text) {
        // Avoid duplicate pins if already pinned.
